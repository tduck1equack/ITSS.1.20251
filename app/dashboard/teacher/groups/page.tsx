          ...
          <Card className="max-w-2xl bg-yellow-50 border border-yellow-300 p-6">
            <Flex direction="column" gap="3">
              ...
              <Text className="text-yellow-800">
                Tính năng quản lý nhóm đang được phát triển. Bạn sẽ có thể tạo
                nhóm, phân công sinh viên, theo dõi tiến độ nhóm trong các phiên
                bản tiếp theo.
              </Text>
              <Text size="2" className="text-yellow-700">
                Dự kiến bao gồm: Tạo nhóm, Phân công sinh viên, Theo dõi hoạt
                động, Đánh giá nhóm.
              </Text>
            </Flex>
          </Card>
